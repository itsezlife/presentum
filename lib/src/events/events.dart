...
> {
  ...
  const factory PresentumEvent.shown({
    required TItem item,
    required DateTime timestamp,
  }) = PresentumShownEvent<TItem, S, V>;

  /// {@macro presentum_dismissed_event}
  const factory PresentumEvent.dismissed({
    required TItem item,
    required DateTime timestamp,
  }) = PresentumDismissedEvent<TItem, S, V>;

  /// {@macro presentum_converted_event}
  const factory PresentumEvent.converted({
    required TItem item,
    required DateTime timestamp,
    Map<String, Object?>? conversionMetadata,
  }) = PresentumConvertedEvent<TItem, S, V>;
