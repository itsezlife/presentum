...
class ShopScope extends StatefulWidget {
  ...
  static void addFavorite(BuildContext context, ProductID id) {
    final deps = Dependencies.of(context);
    deps.favoriteController.add(id);
    deps.recommendationStore.recordInteraction(
      productId: id,
      interactionType: RecommendationInteractionType.addToFavorite,
      triggerRecomputation: false,
    );
  }

  /// Remove a product from the favorite list.
  static void removeFavorite(BuildContext context, ProductID id) =>
...
class _ShopScopeState extends State<ShopScope> {
  ...
  Widget build(BuildContext context) => _InheritedCategories(
    ...
    child: _InheritedProducts(
      table: _tableProduct,
      child: _InheritedFavorite(favorites: _favorites, child: widget.child),
    ),
  );
}
...
final class CategoryContent {
  ...
  late final List<ProductEntity> products = UnmodifiableListView<ProductEntity>(
    _products,
  );
}
...
class _InheritedCategories extends InheritedModel<CategoryID> {
  ...
  static _InheritedCategories? maybeOf(
    BuildContext context, {
    bool listen = true,
  }) => listen
  ...
  static List<CategoryEntity> getRootCategories(
    ...
    bool listen = true,
      ...
      (listen
              ? InheritedModel.inheritFrom<_InheritedCategories>(
                  context,
                  aspect: null,
                )
...
class _InheritedFavorite extends InheritedModel<ProductID> {
  ...
  static _InheritedFavorite? maybeOf(
    BuildContext context, {
    bool listen = true,
  }) => listen
