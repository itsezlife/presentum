...
sealed class FavoriteState extends _$FavoriteStateBase {
  ...
  const FavoriteState({required super.products, required super.message});
...
final class FavoriteState$Idle extends FavoriteState {
  const FavoriteState$Idle({required super.products, super.message = 'Idling'});
}
...
abstract base class _$FavoriteStateBase {
  const _$FavoriteStateBase({required this.products, required this.message});
  ...
  @override
  int get hashCode => Object.hashAll([...products, message]);
