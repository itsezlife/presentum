...
class ProductRepositoryImpl implements IProductRepository {
  ProductRepositoryImpl({required SharedPreferencesWithCache sharedPreferences})
  ...
  Future<void> addFavoriteProduct(ProductID id) async {
    ...
    _favoritesCache = set;
    await _sharedPreferences.setStringList(_favoriteProductsKey, <String>[
  ...
  static List<Map<String, Object?>> _extractCollection(String json) =>
      (jsonDecode(json) as Map<String, Object?>).values
